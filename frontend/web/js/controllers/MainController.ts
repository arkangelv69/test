        ...
        openNavigation(event,card){
            ...
            if( (navigator.platform.indexOf("iPhone") != -1) 
                ...
                || (navigator.platform.indexOf("iPad") != -1))
                 window.open("maps://maps.apple.com/?daddr="+card.attributes.latitude+","+card.attributes.longitude+"&dirflg=d&t=h");
            else
                 window.open("https://maps.google.com/maps?daddr="+card.attributes.latitude+","+card.attributes.longitude+"&ll=");
        }
